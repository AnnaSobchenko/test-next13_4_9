...
import { MainBtn } from "@/interfaces/Props.interface";
...
const ButtonMain: FC<MainBtn> = ({ text, onClick }) => {
  return (
    <button
      onClick={onClick}
      className=" w-fit h-fit bg-transparent pt-1 pb-1 pr-[5px] pl-[5px] border border-solid border-accent-element-color "
    >
